...
enum monitor_id_t {
    ...
    MONITOR_OVLD_SRV_NVDIMM_PAGES_CKPT,
    MONITOR_OVLD_SRV_NVDIMM_PAGES_LSNGAP,
    MONITOR_OVLD_SRV_NVDIMM_PAGES_STORED_WH,
    MONITOR_OVLD_SRV_NVDIMM_PAGES_STORED_DT,
    MONITOR_OVLD_SRV_NVDIMM_PAGES_STORED_CT,
    MONITOR_OVLD_SRV_NVDIMM_PAGES_STORED_HT,
    ...
    MONITOR_OVLD_SRV_NVDIMM_PAGES_READ_WH,
    MONITOR_OVLD_SRV_NVDIMM_PAGES_READ_DT,
    ...
    MONITOR_OVLD_SRV_NVDIMM_PAGES_WRITTEN_WH,
    MONITOR_OVLD_SRV_NVDIMM_PAGES_WRITTEN_DT,
    MONITOR_OVLD_SRV_NVDIMM_PAGES_WRITTEN_CT,
    MONITOR_OVLD_SRV_NVDIMM_PAGES_WRITTEN_HT,
