    ...
    unsigned long int lsn) 
{
  ...
  fprintf(stderr, "flush cache finished--1\n");
  // use cur_offset as size (cur_offset points latest mtr log header written offset)
  ...
  fprintf(stderr, "flush cahe finished--2\n");
